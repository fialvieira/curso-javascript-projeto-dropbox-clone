class DropBoxController {
    ...
    connectFireBase() {
        const firebaseConfig = {
            apiKey: "AIzaSyDqB7HkgZG63mO4Nj1HfsfIyhMQiOC4s_E",
            authDomain: "dropbox-clone-6a64f.firebaseapp.com",
            databaseURL: "https://dropbox-clone-6a64f-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-6a64f",
            storageBucket: "dropbox-clone-6a64f.appspot.com",
            messagingSenderId: "488502277831",
            appId: "1:488502277831:web:b353ee806bee0bb403f0e2",
            measurementId: "G-MTZL3QLL7Z"
        };
        // Initialize Firebase
    ...
    formatTimeToHuman(duration) {
        ...
        if (hours > 0) {
            return `${hours} horas, ${minutes} minutos e ${seconds} segungos`
        }
        if (minutes > 0) {
            return `${minutes} minutos e ${seconds} segungos`
        }
        if (seconds > 0) {
            return `${seconds} segungos`
        }
        return '';
    }
